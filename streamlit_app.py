...
classifier_pipeline = joblib.load('ML_Deployment/resources/ML_artifacts/RFC_pipeline_FINAL.joblib')
Regressor_pipeline = joblib.load('ML_Deployment/resources/ML_artifacts/RR_pipeline_FINAL.joblib')
