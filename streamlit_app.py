...
classifier_pipeline = joblib.load('./resources/ML_artifacts/RFC_pipeline_Final.joblib')
Regressor_pipeline = joblib.load('./resources/ML_artifacts/RR_pipeline_Final.joblib')
